...
M.set_highlights = function()
    local highlights = {
        ...
        Pmenu = { fg = c.color07, bg = c.nvim_bg, sp = "NONE" },
        PmenuSel = { fg = c.nvim_bg, bg = c.color04 },
        ...
        ["@markup.list.checked"] = { fg = c.color06 },
        ["@markup.list.unchecked"] = { fg = c.color07 },
        ...
        ["@text.todo"] = { link = "Todo" },
        ["@text.todo.checked"] = { fg = c.color06 },
        ["@text.todo.unchecked"] = { fg = c.color07 },
        ["@text.note"] = { link = "SpecialComment" },
        ["@text.note.comment"] = { fg = c.color05, bold = true },
        ["@text.warning"] = { link = "WarningMsg" },
        ["@text.danger"] = { link = "ErrorMsg" },
        ["@text.danger.comment"] = { fg = c.fg, bg = c.color01, bold = true },
